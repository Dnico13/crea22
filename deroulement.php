...
<body>
    ...
    <main class="containerDeroulement">
        ...
        <div class="container2whitImage">
            <P class="bulleP">-1- PREMIER RENDEZ-VOUS:<br>
        ...
        <div class="containerSansImage">
            <div class="bulleP order2">-2- DEVIS:<br>
            ...
            <div class="bulleP order3">-3- VALIDATION DU CAHIER DES CHARGES:<br>
        ...
        <div class="container2whitImage2">
            ...
            <p class="bulleP">-4- PRÉSENTATION DU PROJET:<br>
