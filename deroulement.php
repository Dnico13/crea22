...
<body>
    ...
    <main class="containerDeroulement">
        ...
        <div class="containerSansImage">
            <div class="bulleP order2">VALIDATION DU CAHIER DES CHARGES:
            ...
            <div class="bulleP order3">PREMIER RENDEZ-VOUS:
                Nous fixerons un rendez-vous. Celui s’effectue à votre domicile. Ce rendez vous nous permettra de se rencontrer et d’échanger, puis de réaliser un état des lieux. Ensemble nous établirons un cahier des charges précis qui déterminera vos besoins, votre budget et vos envies.</div>
        </div>
